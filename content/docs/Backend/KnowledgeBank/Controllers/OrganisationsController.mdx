...
[SwaggerResponse(400, "Bad Request", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> List(int? pageIndex, int? pageSize)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"pageIndex","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":"(Optional) The index of the page"},{"name":"pageSize","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":"(Optional) The size of the page"}]} />
...
[HttpPatch("update/{id}")]
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Updates an organistation")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the organistation"},{"name":"updates","type":"Dictionary<string, object>","links":["https://learn.microsoft.com/dotnet/api/system.collections.generic.dictionary-2","https://learn.microsoft.com/dotnet/api/system.string","https://learn.microsoft.com/dotnet/api/system.object"],"description":"The dictionary of propertynames to update and their new values"}]} />
