...
---
###  OrganisationsController\(ResourceManager\)
...
```csharp
public OrganisationsController(ResourceManager resourceManager)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"resourceManager","type":"ResourceManager","links":["../Data/ResourceManager"],"description":"The resource manager service for database interactions"}]} />
...
[SwaggerOperation(null, null, Summary = "Adds a relation to the organisation")]
...
[SwaggerOperation(null, null, Summary = "Deletes a person")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the organisation"}]} />
...
[HttpGet("exists")]
[SwaggerOperation(null, null, Summary = "Check if an organisation exists")]
[SwaggerResponse(200, "Response with boolean indicating if organisation exists.", typeof(ApiResponse))]
[SwaggerResponse(400, "Bad Request", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> Exists(string? name)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"name","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The name of the organisation"}]} />
...
```csharp
[HttpGet("info/{id}")]
[SwaggerOperation(null, null, Summary = "Get the information of the organisation")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the organisation"},{"name":"properties","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The properties you are trying to receive, separated by comma"}]} />
...
```csharp
[HttpGet("list")]
[SwaggerOperation(null, null, Summary = "Retrieves a list or page of all organisations")]
...
[SwaggerResponse(400, "Bad Request", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> New(OrganisationCreateDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"OrganisationCreateDto","links":["../Models/OrganisationCreateDto"],"description":"The Data Transfer Object"}]} />
...
[SwaggerOperation(null, null, Summary = "Retrieves all relations of the given type for the given organisation ID")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"relation","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The relation to retrieve"},{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the organisation"},{"name":"properties","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"(Optional) The properties to select from the result"}]} />
...
[SwaggerOperation(null, null, Summary = "Removes a relation to the organisation")]
...
[HttpPatch("trash/{id}")]
[Authorize]
[SwaggerOperation(null, null, Summary = "Trashes an organisation.")]
...
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Untrashes an organisation.")]
...
[HttpPatch("update/{id}")]
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Updates an organisation")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the organisation"},{"name":"updates","type":"Dictionary<string, object>","links":["https://learn.microsoft.com/dotnet/api/system.collections.generic.dictionary-2","https://learn.microsoft.com/dotnet/api/system.string","https://learn.microsoft.com/dotnet/api/system.object"],"description":"The dictionary of propertynames to update and their new values"}]} />
