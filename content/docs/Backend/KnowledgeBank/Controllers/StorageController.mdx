...
---
###  StorageController\(IAzureBlobService, ResourceManager\)
...
<TypeTable types={[{"name":"blobService","type":"IAzureBlobService","links":["../Data/IAzureBlobService"],"description":""},{"name":"resourceManager","type":"ResourceManager","links":["../Data/ResourceManager"],"description":""}]} />
...
[SwaggerOperation(null, null, Summary = "Delete a file from storage.", Description = "Deletes the given file from the given container in the Azure Blob Storage.")]
...
public Task<IActionResult> DeleteFile(string id)
```
...
```csharp
[HttpGet("download/{id}")]
[SwaggerOperation(null, null, Summary = "Download a file from storage.", Description = "Downloads a given blob from the given container in the Azure Blob Storage.")]
[SwaggerResponse(200, "File found and returned", null)]
[SwaggerResponse(404, "File not found", typeof(StorageResponse))]
...
[HttpGet("exists/{hash}")]
[SwaggerOperation(null, null, Summary = "Check if a file exists.", Description = "Checks if the given file exists based on its hash.")]
[SwaggerResponse(200, "Response with boolean indicating if file exists.", typeof(StorageResponse))]
[SwaggerResponse(400, "Invalid filename", typeof(StorageResponse))]
[SwaggerResponse(500, "Server error", typeof(StorageResponse))]
public Task<IActionResult> Exists(string hash)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"hash","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":""}]} />
...
```csharp
[HttpGet("file/{id}")]
[SwaggerOperation(null, null, Summary = "Get information of file.", Description = "Retrieve the database information of the given file.")]
[SwaggerResponse(200, "File information.", typeof(StorageResponse))]
[SwaggerResponse(404, "File not found.", typeof(StorageResponse))]
[SwaggerResponse(400, "Invalid ID.", typeof(StorageResponse))]
[SwaggerResponse(500, "Server error.", typeof(StorageResponse))]
public Task<IActionResult> FileInfo(string id)
```
...
```csharp
[HttpGet("list-all")]
[SwaggerOperation(null, null, Summary = "List all files in storage.", Description = "Lists all files in the storage, sorted by creation date (newest first).")]
...
```csharp
[HttpGet("list-paged")]
[SwaggerOperation(null, null, Summary = "Lists files paged.", Description = "Lists files on a certain page of certain size.")]
...
[SwaggerResponse(500, "Server error", typeof(StorageResponse))]
public Task<IActionResult> ListPaged(int pageIndex = 1, int pageSize = 100)
```
...
---
###  Rename\(ResourceRenameDto\)

```csharp
[HttpPatch("rename")]
[SwaggerOperation(null, null, Summary = "Renames a file in storage.", Description = "Rename the given file to the new location in the Azure Blob Storage. The destination file name will be made unique by this function.")]
...
[SwaggerResponse(500, "Server error", typeof(StorageResponse))]
public Task<IActionResult> Rename(ResourceRenameDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"ResourceRenameDto","links":["../Models/ResourceRenameDto"],"description":""}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":""}]} />

---
###  UploadFile\(FileResourceCreateDto\)

```csharp
[HttpPut("upload")]
[Obsolete]
[SwaggerOperation(null, null, Summary = "Upload a file to storage.", Description = "Uploads a file to Azure Blob Storage and returns metadata.")]
...
[SwaggerResponse(500, "Server error", typeof(StorageResponse))]
public Task<IActionResult> UploadFile(FileResourceCreateDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"FileResourceCreateDto","links":["../Models/FileResourceCreateDto"],"description":""}]} />
