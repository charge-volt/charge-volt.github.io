...
---
###  RegionsController\(ResourceManager\)
...
```csharp
public RegionsController(ResourceManager resourceManager)
```
...
[SwaggerOperation(null, null, Summary = "Deletes a region")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the region"}]} />
...
[HttpGet("exists")]
[SwaggerOperation(null, null, Summary = "Check if a region exists")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"name","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The name of the region"}]} />
...
```csharp
[HttpGet("info/{id}")]
[SwaggerOperation(null, null, Summary = "Get the information of the region")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the region"},{"name":"properties","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The properties you are trying to receive, separated by comma"}]} />
...
```csharp
[HttpGet("list")]
[SwaggerOperation(null, null, Summary = "Retrieves a list or page of all regions")]
[SwaggerResponse(200, "A list or page of all the regions in the archive", typeof(ApiResponse))]
[SwaggerResponse(400, "Bad Request", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> List(int? pageIndex, int? pageSize, string? properties, string? searchQuery)
```
...
```csharp
[HttpPut("new")]
[SwaggerOperation(null, null, Summary = "Create a new region in the archive")]
...
[SwaggerResponse(400, "Bad Request", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> New(RegionCreateDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"RegionCreateDto","links":["../Models/RegionCreateDto"],"description":"The Data Transfer Object"}]} />
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the region"},{"name":"updates","type":"Dictionary<string, object>","links":["https://learn.microsoft.com/dotnet/api/system.collections.generic.dictionary-2","https://learn.microsoft.com/dotnet/api/system.string","https://learn.microsoft.com/dotnet/api/system.object"],"description":"The dictionary of propertynames to update and their new values"}]} />
