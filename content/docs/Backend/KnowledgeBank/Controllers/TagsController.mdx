...
---
###  TagsController\(ResourceManager, ProjectManager\)

```csharp
public TagsController(ResourceManager resourceManager, ProjectManager projectManager)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"resourceManager","type":"ResourceManager","links":["../Data/ResourceManager"],"description":""},{"name":"projectManager","type":"ProjectManager","links":["../Data/ProjectManager"],"description":""}]} />

---
## Methods

---
###  AddStandardTag\(TagCreateDto\)
...
[SwaggerOperation(null, null, Summary = "Adds new standard tag.", Description = "Lets an admin add a new tag to the list of standardized tags.")]
[SwaggerResponse(200, "New tag added", typeof(Guid))]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(409, "Tag already exists", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> AddStandardTag(TagCreateDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"TagCreateDto","links":["../Models/TagCreateDto"],"description":"The DTO for tag creation."}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"Returns a 200 OK response containing the added tag."}]} />
...
[SwaggerOperation(null, null, Summary = "Adds new tag.", Description = "Adds a tag.")]
[SwaggerResponse(200, "New tag added", typeof(Guid))]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(409, "Tag already exists", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> AddTag(TagCreateDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"TagCreateDto","links":["../Models/TagCreateDto"],"description":""}]} />
...
[Authorize(Policy = "RequireAdminRole")]
[SwaggerResponse(200, "Tag was approved", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(404, "Tag not found", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> ApproveTag(string id)
```
...
[Authorize]
[SwaggerOperation(null, null, Summary = "Change tag name.", Description = "Lets admins change the name of any tag, and users their own tags if not assigned to resources.")]
[SwaggerResponse(200, "Tag name changed", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(403, "Forbidden - User cannot edit this tag", null)]
[SwaggerResponse(404, "Tag not found", null)]
[SwaggerResponse(409, "Tag already exists", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> ChangeTagName(string id, string newName)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The id of the tag."},{"name":"newName","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The new name of the tag."}]} />
...
[Authorize]
[SwaggerOperation(null, null, Summary = "Deletes a tag.", Description = "Lets admins delete any tag, and users delete their own tags if not assigned to resources.")]
[SwaggerResponse(200, "Tag deleted", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(403, "Forbidden - User cannot delete this tag", null)]
[SwaggerResponse(404, "Tag not found", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> DeleteTag(string id)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The id of the tag to delete."}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"Returns a 200 OK response containing the deleted tag."}]} />
...
[HttpGet("all-tags")]
[SwaggerOperation(null, null, Summary = "List all tags.", Description = "List all tags.")]
...
<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"Returns a 200 OK response containing a list of all tags."}]} />

---
###  GetAllPaged\(int, int, string?\)

```csharp
[Obsolete("Deprecated, use GetTags instead. Method can be removed once frontend is updated")]
[HttpGet("tag-page")]
[SwaggerOperation(null, null, Summary = "List all tags paged.", Description = "List all tags paged.")]
[SwaggerResponse(200, "List of tags", typeof(Tag[]))]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetAllPaged(int pageIndex = 1, int pageSize = 100, string? searchQuery = null)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"pageIndex","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":""},{"name":"pageSize","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":""},{"name":"searchQuery","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":""}]} />
...
[SwaggerOperation(null, null, Summary = "List all standardized tags.", Description = "List all standardizedtags.")]
[SwaggerResponse(200, "List of tags", typeof(Tag[]))]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetAllStandardized()
```
...
---
###  GetAllStandardizedPaged\(int, int\)

```csharp
[Obsolete("Deprecated, use GetTags instead. Method can be removed once frontend is updated")]
[HttpGet("standard-tag-page")]
[SwaggerOperation(null, null, Summary = "List all standardized tags paged.", Description = "List all standardized tags paged.")]
[SwaggerResponse(200, "List of tags", typeof(Tag[]))]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetAllStandardizedPaged(int pageIndex = 1, int pageSize = 100)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"pageIndex","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":""},{"name":"pageSize","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":""}]} />
...
[SwaggerOperation(null, null, Summary = "List all user tags.", Description = "List all user tags.")]
[SwaggerResponse(200, "List of tags", typeof(Tag[]))]
[SwaggerResponse(500, "Internal server error", null)]
...
---
###  GetAllUserPaged\(int, int\)

```csharp
[Obsolete("Deprecated, use GetTags instead. Method can be removed once frontend is updated")]
[HttpGet("user-tag-page")]
[SwaggerOperation(null, null, Summary = "List all user tags paged.", Description = "List all user tags paged.")]
[SwaggerResponse(200, "List of tags", typeof(Tag[]))]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetAllUserPaged(int pageIndex = 1, int pageSize = 100)
```
...
---
###  GetTags\(TagFilterOptions\)

Retrieves tags with advanced filtering, searching, paging and sorting capabilities

```csharp
[HttpPost("tags")]
[SwaggerOperation(null, null, Summary = "Get tags with advanced filtering and sorting", Description = "Retrieve tags with options for pagination, filtering by multiple properties, and sorting")]
[SwaggerResponse(200, "List of tags", typeof(Tag[]))]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetTags(TagFilterOptions filterOptions)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"filterOptions","type":"TagFilterOptions","links":["../Models/TagFilterOptions"],"description":""}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"Returns a 200 OK response containing a list of tags."}]} />

---
###  MakeStandardized\(string\)

```csharp
[HttpPatch("make-standardized/{id}")]
[Authorize(Policy = "RequireAdminRole")]
[SwaggerResponse(200, "Tag was standardized", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(404, "Tag not found", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> MakeStandardized(string id)
```
...
[Authorize(Policy = "RequireAdminRole")]
[SwaggerResponse(200, "Tags merged", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(404, "Tag(s) not found", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> Merge(string id1, string id2)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id1","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The id of the first tag."},{"name":"id2","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The id of the second tag."}]} />
