...
---
###  AuthController\(IConfiguration, SignInManager\<User\>, DatabaseContext, MailUtils\)
...
<TypeTable types={[{"name":"config","type":"IConfiguration","links":["https://learn.microsoft.com/dotnet/api/microsoft.extensions.configuration.iconfiguration"],"description":""},{"name":"signInManager","type":"SignInManager<User>","links":["https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.identity.signinmanager-1","../Models/User"],"description":""},{"name":"context","type":"DatabaseContext","links":["../Data/DatabaseContext"],"description":""},{"name":"mailUtils","type":"MailUtils","links":["../Utils/MailUtils"],"description":""}]} />
...
```csharp
[HttpGet("get-user-id")]
[SwaggerOperation(null, null, Summary = "Gets current user id", Description = "Gets the id of the current user.")]
[SwaggerResponse(200, "User id fetched successfully", null)]
[SwaggerResponse(500, "Server error", null)]
public Task<IActionResult> GetUserId()
```

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"User id of the current user"}]} />
...
[SwaggerOperation(null, null, Summary = "Invite a new user", Description = "Invite a new user to the system")]
[SwaggerResponse(200, "The user has been invited", null)]
[SwaggerResponse(401, "The user is not authenticated", null)]
public Task<IActionResult> Invite(string email)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"email","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":""}]} />
...
[Authorize]
[Route("logout")]
[SwaggerOperation(null, null, Summary = "Logs out the current user", Description = "Logs out the current user")]
[SwaggerResponse(200, "The user has been logged out", null)]
[SwaggerResponse(401, "The user is not authenticated", null)]
public Task<IActionResult> Logout(object empty)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"empty","type":"object","links":["https://learn.microsoft.com/dotnet/api/system.object"],"description":""}]} />
...
[Authorize]
[Route("ping")]
[SwaggerOperation(null, null, Summary = "Gets the current user's email", Description = "Returns the email of the currently authenticated user")]
...
```csharp
[HttpPost("signup")]
[SwaggerOperation(null, null, Summary = "Register a new user", Description = "Register a new user")]
[SwaggerResponse(200, "The user has been registered", null)]
[SwaggerResponse(400, "Bad request", null)]
public Task<IActionResult> Register(SignUpDto signUpDto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"signUpDto","type":"SignUpDto","links":["../Models/SignUpDto"],"description":""}]} />
...
[SwaggerOperation(null, null, Summary = "Updates the user's password", Description = "Updates the user's password")]
[SwaggerResponse(200, "The password has been changed", null)]
[SwaggerResponse(400, "Bad request", null)]
public Task<IActionResult> UpdatePassword(ChangePasswordDto changePasswordDto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"changePasswordDto","type":"ChangePasswordDto","links":["../Models/ChangePasswordDto"],"description":""}]} />
