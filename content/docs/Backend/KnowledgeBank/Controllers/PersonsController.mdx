...
---
###  PersonsController\(ResourceManager\)
...
```csharp
public PersonsController(ResourceManager resourceManager)
```
...
[SwaggerOperation(null, null, Summary = "Adds a relation to the person")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the person"}]} />
...
[HttpGet("exists")]
[SwaggerOperation(null, null, Summary = "Check if a person exists")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"name","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The name of the person"}]} />
...
```csharp
[HttpGet("info/{id}")]
[SwaggerOperation(null, null, Summary = "Get the information of the person")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the person"},{"name":"properties","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The properties you are trying to receive, separated by comma"}]} />
...
```csharp
[HttpGet("list")]
[SwaggerOperation(null, null, Summary = "Retrieves a list or page of all persons")]
...
```csharp
[HttpPut("new")]
[SwaggerOperation(null, null, Summary = "Create a new person in the archive")]
...
[SwaggerResponse(400, "Bad Request", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> New(PersonCreateDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"PersonCreateDto","links":["../Models/PersonCreateDto"],"description":"The Data Transfer Object"}]} />
...
[SwaggerOperation(null, null, Summary = "Retrieves all relations of the given type for the given person ID")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"relation","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The relation to retrieve"},{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the person"},{"name":"properties","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"(Optional) The properties to select from the result"}]} />
...
[SwaggerOperation(null, null, Summary = "Removes a relation to the person")]
...
[HttpPatch("trash/{id}")]
[Authorize]
[SwaggerOperation(null, null, Summary = "Trashes a person.")]
...
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Untrashes a person.")]
...
[HttpPatch("update/{id}")]
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Updates a person")]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The ID of the person"},{"name":"updates","type":"Dictionary<string, object>","links":["https://learn.microsoft.com/dotnet/api/system.collections.generic.dictionary-2","https://learn.microsoft.com/dotnet/api/system.string","https://learn.microsoft.com/dotnet/api/system.object"],"description":"The dictionary of propertynames to update and their new values"}]} />
