...
---
###  SearchController\(IAzureBlobService, DatabaseContext\)
...
<TypeTable types={[{"name":"blobService","type":"IAzureBlobService","links":["../Data/IAzureBlobService"],"description":""},{"name":"databaseContext","type":"DatabaseContext","links":["../Data/DatabaseContext"],"description":""}]} />

---
## Methods

---
###  FullTextSearch\(string?, int, int, FilterDto?\)

```csharp
[HttpPost("search-full-text")]
[SwaggerOperation(null, null, Summary = "FTS the database by title and description.", Description = "FTS for resources in database based by title and description, with pagination.")]
[SwaggerResponse(200, "List of search results", typeof(List<Resource>))]
[SwaggerResponse(400, "Invalid search query", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> FullTextSearch(string? query, int pageIndex = 1, int pageSize = 20, FilterDto? filter = null)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"query","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":""},{"name":"pageIndex","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":""},{"name":"pageSize","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":""},{"name":"filter","type":"FilterDto","links":["../Models/FilterDto"],"description":""}]} />
...
[SwaggerOperation(null, null, Summary = "Returns the oldest document year.", Description = "Searches the whole Resources table and returns the oldest one from that table.")]
[SwaggerResponse(200, "Oldest document", typeof(List<Resource>))]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetOldestDocument()
```
...
---
###  SearchByDescription\(string, int, int, FilterDto?\)

```csharp
[HttpPost("search-description")]
[SwaggerOperation(null, null, Summary = "Search database by description.", Description = "Searches for resources in database based on a given description, with pagination.")]
[SwaggerResponse(200, "List of search results", typeof(List<Resource>))]
[SwaggerResponse(400, "Invalid search query", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> SearchByDescription(string query, int pageIndex = 1, int pageSize = 20, FilterDto? filter = null)
```
...
---
###  SearchByTitle\(string, int, int, FilterDto?\)

```csharp
[HttpPost("search-title")]
[SwaggerOperation(null, null, Summary = "Search database by title.", Description = "Searches for resources in database based on a given title, with pagination.")]
[SwaggerResponse(200, "List of search results", typeof(List<Resource>))]
[SwaggerResponse(400, "Invalid search query", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> SearchByTitle(string query, int pageIndex = 1, int pageSize = 20, FilterDto? filter = null)
```
