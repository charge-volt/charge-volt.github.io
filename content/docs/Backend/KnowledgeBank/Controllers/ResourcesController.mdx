...
[Authorize]
[SwaggerOperation(null, null, Summary = "Archives a resource.")]
...
public Task<IActionResult> Archive(string id)
```
...
[SwaggerResponse(400, "Bad Request", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> List(int? pageIndex, int? pageSize, bool archived = false)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"pageIndex","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":"(Optional) The index of the page"},{"name":"pageSize","type":"int","links":["https://learn.microsoft.com/dotnet/api/system.int32"],"description":"(Optional) The size of the page"},{"name":"archived","type":"bool","links":["https://learn.microsoft.com/dotnet/api/system.boolean"],"description":"(Optional) Whether to show archived resources or non archived resources"}]} />
...
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Unarchives a resource.")]
[SwaggerResponse(200, "Resource unarchived successfully", typeof(ApiResponse))]
[SwaggerResponse(404, "Resource not found", typeof(ApiResponse))]
[SwaggerResponse(400, "Invalid ID", typeof(ApiResponse))]
[SwaggerResponse(500, "Internal Server Error", typeof(ApiResponse))]
public Task<IActionResult> Unarchive(string id)
```
