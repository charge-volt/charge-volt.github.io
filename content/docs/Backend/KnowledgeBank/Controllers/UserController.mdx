...
---
###  UserController\(DatabaseContext, UserManager\<User\>\)
...
<TypeTable types={[{"name":"databaseContext","type":"DatabaseContext","links":["../Data/DatabaseContext"],"description":""},{"name":"userManager","type":"UserManager<User>","links":["https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.identity.usermanager-1","../Models/User"],"description":""}]} />
...
```csharp
[HttpDelete("delete")]
[SwaggerOperation(null, null, Summary = "Delete a user.", Description = "Deletes a user by ID.")]
[SwaggerResponse(200, "User deleted successfully.", null)]
...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"userId","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":""}]} />
...
[SwaggerOperation(null, null, Summary = "Gets all users", Description = "Gets a list of all users.")]
[SwaggerResponse(200, "Users are loaded succesfully", null)]
[SwaggerResponse(500, "Server error", null)]
...
[AllowAnonymous]
[SwaggerOperation(null, null, Summary = "Get current user's first name.", Description = "Returns the current user's first name or an empty string if not authenticated")]
[SwaggerResponse(200, "The current user's first name.", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetCurrentUserFirstName()
```

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"The user's first name."}]} />
...
[AllowAnonymous]
[SwaggerOperation(null, null, Summary = "Get current user's last name.", Description = "Returns the current user's name or an empty string if not authenticated")]
[SwaggerResponse(200, "The current user's last name.", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetCurrentUserLastName()
```

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"The user's last name"}]} />
...
[AllowAnonymous]
[SwaggerOperation(null, null, Summary = "Get current user's name.", Description = "Returns the current user's name or an empty string if not authenticated")]
[SwaggerResponse(200, "The current user's name.", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetCurrentUserName()
```

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"The user's full name."}]} />

---
###  GetUsersPaged\(int, int, string?\)

```csharp
[AllowAnonymous]
[HttpGet("list-paged")]
[SwaggerOperation(null, null, Summary = "Gets a page of users", Description = "Gets a page of users.")]
[SwaggerResponse(200, "Users are loaded succesfully", null)]
[SwaggerResponse(500, "Server error", null)]
public Task<IActionResult> GetUsersPaged(int pageIndex = 1, int pageSize = 100, string? searchQuery = null)
```
...
```csharp
[HttpPut("update")]
[SwaggerOperation(null, null, Summary = "Update the current user.", Description = "Updates the current user's information.")]
[SwaggerResponse(200, "User updated successfully.", null)]
[SwaggerResponse(400, "User email already exists.", null)]
[SwaggerResponse(404, "User not found.", null)]
[SwaggerResponse(500, "Internal server error.", null)]
public Task<IActionResult> Update(UpdateUserDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"UpdateUserDto","links":["../Models/UpdateUserDto"],"description":"The data transfer object containing the user's updated information."}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"An IActionResult with information about the success of the action."}]} />

---
###  UpdateMail\(UpdateEmailDto\)

```csharp
[HttpPatch("update-mail")]
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Updates the user email.", Description = "Updates the email of the user.")]
[SwaggerResponse(200, "User email updated successfully.", null)]
[SwaggerResponse(400, "User email already exists.", null)]
[SwaggerResponse(404, "User not found.", null)]
[SwaggerResponse(500, "Internal server error.", null)]
public Task<IActionResult> UpdateMail(UpdateEmailDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"UpdateEmailDto","links":["../Models/UpdateEmailDto"],"description":""}]} />
