...
Namespace: [KnowledgeBank.controllers](KnowledgeBank.controllers.md)  
...
---
###  MiscController\(ResourceManager\)

```csharp
public MiscController(ResourceManager resourceManager)
```
...
[SwaggerOperation(null, null, Summary = "Get filetype id.", Description = "Get filetype id by searching on name.")]
[SwaggerResponse(200, "FileType ID", typeof(Tag[]))]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(404, "FileType not found", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> GetFileType(string name)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"name","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":""}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"Returns a 200 OK response containing the ID of the filetype."}]} />
