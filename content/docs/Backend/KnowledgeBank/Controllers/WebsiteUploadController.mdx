...
---
###  WebsiteUploadController\(ResourceManager\)

```csharp
public WebsiteUploadController(ResourceManager resourceManager)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"resourceManager","type":"ResourceManager","links":["../Data/ResourceManager"],"description":""}]} />

---
## Methods

---
###  AddWebsite\(WebsiteCreateDto\)

Uploads a new website to the database.

```csharp
[HttpPut("add-website")]
[SwaggerOperation(null, null, Summary = "Uploads a new website.", Description = "Lets a user upload a new website to the archive.")]
[SwaggerResponse(200, "New website uploaded", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(409, "Website already exists in database", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> AddWebsite(WebsiteCreateDto dto)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"dto","type":"WebsiteCreateDto","links":["../Models/WebsiteCreateDto"],"description":"The dto used for adding the website to the db."}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"Returns an OK response."}]} />

---
###  ChangeWebsite\(string, string, WebsiteColumn\)
...
[SwaggerOperation(null, null, Summary = "Change website.", Description = "Lets an admin change a website.")]
[SwaggerResponse(200, "Website changed", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(404, "Website not found", null)]
[SwaggerResponse(409, "New URL already exists", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> ChangeWebsite(string id, string newTitleOrURL, WebsiteColumn column)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"id of the website"},{"name":"newTitleOrURL","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"the new title or url to change to"},{"name":"column","type":"WebsiteColumn","links":["../Models/WebsiteColumn"],"description":"the attribute to change"}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"Task<IActionResult>","links":["https://learn.microsoft.com/dotnet/api/system.threading.tasks.task-1","https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"Ok if it succeeds"}]} />
...
[Authorize(Policy = "RequireAdminRole")]
[SwaggerOperation(null, null, Summary = "Delete website.", Description = "Lets an admin delete a website.")]
[SwaggerResponse(200, "Website deleted", null)]
[SwaggerResponse(400, "Bad request", null)]
[SwaggerResponse(404, "Website not found", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> DeleteWebsite(string id)
```

<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"id","type":"string","links":["https://learn.microsoft.com/dotnet/api/system.string"],"description":"The id of the website to delete."}]} />
...
[SwaggerOperation(null, null, Summary = "lists all websites", Description = "HttpGet request that fetches all websites uploaded to the archive")]
[SwaggerResponse(200, "List of websites", null)]
[SwaggerResponse(500, "Internal server error", null)]
...
[SwaggerOperation(null, null, Summary = "gets website by id", Description = "HttpGet request that fetches the website url that corresponds with the id")]
[SwaggerResponse(200, "URL of website", null)]
[SwaggerResponse(500, "Internal server error", null)]
public Task<IActionResult> Get_Website(string id)
```
