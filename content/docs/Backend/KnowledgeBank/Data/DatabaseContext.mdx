...
#### Property Value
 ...
 <a href='https://learn.microsoft.com/dotnet/api/microsoft.entityframeworkcore.dbset\-1' target='_blank' className="no-underline text-inherit hover:text-inherit inline"><CSharpType type='DbSet' /></a>\<<a href='../Models/ResourceVector' target='_self' className="no-underline text-inherit hover:text-inherit inline"><CSharpType type='ResourceVector' /></a>\>
...
---
###  SaveProjectChangesAsync\(CancellationToken\)
...
```csharp
public Task<int> SaveProjectChangesAsync(CancellationToken cancellationToken = default)
```
